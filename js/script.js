...
// Xử lý sự kiện click cho các ô vuông text
document.querySelectorAll('.text-box').forEach(function(box) {
    box.addEventListener('click', function(e) {
        e.stopPropagation();
        var boxIcon = this.querySelector('.box-icon');
        var boxText = this.querySelector('.box-text');
        
        // Toggle text hiện tại độc lập
        if (boxText.style.display === 'none' || boxText.style.display === '') {
            boxIcon.style.display = 'none';
            boxText.style.display = 'flex';
        } else {
            boxIcon.style.display = '';
            boxText.style.display = 'none';
        }
    });
});

// Đóng text khi click bên ngoài
document.addEventListener('click', function(event) {
    if (!event.target.closest('.text-box')) {
        document.querySelectorAll('.text-box').forEach(function(box) {
            var boxIcon = box.querySelector('.box-icon');
